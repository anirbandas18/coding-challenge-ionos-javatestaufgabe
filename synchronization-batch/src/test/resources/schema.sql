...
CREATE TABLE dummy (
    auftragid bigint IDENTITY NOT NULL,
    aritkelnummer varchar(255) NOT NULL,
    created varchar(255) NOT NULL,
    lastchange varchar(255) NOT NULL,
    kundeid bigint unsigned NOT NULL
);
create index idx_dummy_auftragid on dummy(auftragid);

CREATE TABLE kunde (
    kundenid bigint IDENTITY NOT NULL,
...
create index idx_kunde_kundenid on kunde(kundenid);
