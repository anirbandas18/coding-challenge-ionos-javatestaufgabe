...
DROP TABLE IF EXISTS `S3EXPORT_SYNC_DB`.`auftraege`;

CREATE TABLE `S3EXPORT_SYNC_DB`.`auftraege` (
...
DROP TABLE IF EXISTS `S3EXPORT_SYNC_DB`.`dummy`;

CREATE TABLE `S3EXPORT_SYNC_DB`.`dummy` (
...
DROP TABLE IF EXISTS `S3EXPORT_SYNC_DB`.`kunde`;

CREATE TABLE `S3EXPORT_SYNC_DB`.`kunde` (
...
#
# TABLE STRUCTURE FOR: spring batch framework
#
